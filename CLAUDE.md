...
- `assets/` — files shipped with the repo and read by the programs (audio, motion CSVs, head
  segments). All tracked, except large music/vocal WAVs (distributed separately).
