...
class TestASRIntegration:
    def test_streaming_feed_and_get_text(self, asr_wav: Path, asr_lang: str) -> None:
        ...
        """
        info, frames = read_wav_frames(asr_wav)
    ...
    def test_reset_between_turns(self, asr_wav: Path, asr_lang: str) -> None:
    ...
    def test_stop_during_active_stream(self, asr_wav: Path, asr_lang: str) -> None:
...
class TestASRErrorRecovery:
    ...
    def test_invalid_language_code_propagates_error(self, asr_wav: Path, asr_lang: str) -> None:
        """An invalid language code should surface an RuntimeError during streaming.
    ...
    def test_recovery_after_error_via_stop_start(self, asr_wav: Path, asr_lang: str) -> None:
    ...
    def test_reset_recovers_from_stale_stream(self, asr_wav: Path, asr_lang: str) -> None:
    ...
    def test_double_stop_is_safe(self, asr_wav: Path, asr_lang: str) -> None:
