...
from voice_pipeline.tests.adapters.conftest import read_wav_frames
...
class TestWakewordDetection:
    ...
    def test_detects_wakeword_in_speech(self, wakeword_wav, wakeword_keyword, monkeypatch):
        """Feed WAV containing the wakeword → returns True at some point."""
        _, frames = read_wav_frames(wakeword_wav)
        ...
        assert detected, f"Wakeword '{wakeword_keyword}' not detected in {wakeword_wav} ({len(frames)} frames)"
    ...
    def test_multiple_detection_cycles(self, wakeword_wav, wakeword_keyword, monkeypatch):
