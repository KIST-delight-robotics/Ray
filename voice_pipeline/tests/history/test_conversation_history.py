...
from voice_pipeline.core.types import LLMMetrics, Usage
...
def _make_history() -> tuple[ConversationHistory, MemoryStorageBackend]:
...
class TestWriteThrough:
    ...
    def test_save_calls_end_session(self) -> None:
        ...
        h.new_session("s1")
        h.save()
        session = backend._sessions.get("s1")
