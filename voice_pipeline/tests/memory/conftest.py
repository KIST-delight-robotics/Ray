...
CONVERSATION_MOVIE: list[tuple[str, str, str, int]] = [
    ...
    ("assistant", "인터스텔라 정말 좋은 영화죠! 어떤 장면이 가장 인상 깊었나요?", "2026-04-01 10:00:05", 15),
    ("user", "우주 장면이 너무 아름다웠고, 마지막에 눈물이 났어. 놀란 감독 영화를 다 좋아해.", "2026-04-01 10:00:10", 16),
    ("assistant", "놀란 감독의 영화는 정말 명작이 많죠. 다크나이트도 좋아하시나요?", "2026-04-01 10:00:15", 14),
    ("user", "응, 다크나이트도 좋아하지. 히스 레저의 조커 연기가 최고였어.", "2026-04-01 10:00:20", 14),
...
CONVERSATION_PERSONAL: list[tuple[str, str, str, int]] = [
    ...
    ("assistant", "빌 에반스는 정말 훌륭한 재즈 피아니스트죠! 어떤 앨범을 들으셨어요?", "2026-04-01 11:00:05", 14),
    ("user", "Waltz for Debby를 매일 듣고 있어. 나는 서울에 살고 있고, 프로그래머로 일하고 있어.", "2026-04-01 11:00:10", 18),
    ("assistant", "서울에서 프로그래머로 일하시는군요! 재즈를 들으며 코딩하면 집중이 잘 되겠네요.", "2026-04-01 11:00:15", 16),
...
CONVERSATION_COOKING: list[tuple[str, str, str, int]] = [
    ...
    ("assistant", "직접 만든 파스타, 대단하시네요! 어떤 소스를 사용하셨어요?", "2026-04-01 12:00:05", 14),
    ("user", "크림 소스에 버섯을 넣었어. 이탈리안 요리를 배우고 싶어.", "2026-04-01 12:00:10", 14),
    ("assistant", "크림 버섯 파스타 정말 맛있겠네요! 이탈리안 요리 배우시면 더 다양한 요리를 할 수 있겠어요.", "2026-04-01 12:00:15", 18),
