...
When the user asks to turn the light on or off (or toggle it), call the control_light tool. \
After the tool runs, briefly confirm the action to the user in English \
(for example, "Okay, I turned the light off.").
